...
# - tempo_conta (em meses desde a criação da conta do usuário)
...
data = {
    'valor_transacao': [15, 200, 3500, 60, 500, 90000, 30, 850, 4999],
...
filename = 'modelo_fraude.pkl'
with open(filename, 'wb') as f:
    pickle.dump(model, f)

print(f"Modelo de fraude treinado e salvo em '{filename}'")